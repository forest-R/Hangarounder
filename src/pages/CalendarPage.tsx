...
const COLORS = ["#97C459", "#5DCAA5", "#EF9F27", "#85B7EB", "#ED93B1", "#F0997B"];
      ...
      <div className="flex items-center justify-between px-5 pt-6 pb-3">
        ...
        <div className="flex gap-1">
          <button
            ...
            className="w-8 h-8 flex items-center justify-center rounded-full text-forest-600 active:bg-forest-100"
          >‹</button>
          <button
            onClick={() => setMonth(new Date())}
            className="px-3 h-8 flex items-center justify-center rounded-full text-xs text-forest-600 border border-forest-200 active:bg-forest-100"
          >오늘</button>
          <button
